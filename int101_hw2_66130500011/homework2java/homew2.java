...
public class homew2 {
        ...
        static void work01Utilitor() {
            System.out.println(Utilitor.testString("Khanisorn"));
            //System.out.println(Utilitor.testString(""));//
            System.out.println(Utilitor.testPositive(70));
            //System.out.println(Utilitor.testPositive(-2));//
            System.out.println(Utilitor.computeIsbn10(185_695_256));
           /*
        ...
        static void work02Person() {
            ...
            Person person1 = new Person("Khanisorn", "Dachom");
            System.out.println(person1);
            Person person2 = new Person("Jame", "clark");
        ...
        static void work03Account() {
            ...
            System.out.println(account1.deposit(7500.00));
            System.out.println(account1.getBalance());
            System.out.println(account2.deposit(5000.00));
            System.out.println(account2.getBalance() + "" + '\n');

            System.out.println(account1.withdraw(2000.00));
            System.out.println(account1.getBalance());
            System.out.println(account2.withdraw(1000.00));
            System.out.println(account2.getBalance() + "" + '\n');
